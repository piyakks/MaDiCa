...
from .encoders.single_vmamba_camo import vssm_small as backbone
...
class Model(nn.Module):
    def __init__(self,img_size=352):
        ...
        self.decoder = MambaDecoder(img_size=[img_size, img_size], 
    ...
    def forward(self, rgb):
        ...
        orisize = rgb.shape
        x, saliency,background = self.backbone(rgb)
