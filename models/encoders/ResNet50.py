...
def Backbone_ResNet50_in3():
    ...
    div_4 = nn.Sequential(*list(net.children())[:5])
    div_8 = net.layer2
    div_16 = net.layer3
    div_32 = net.layer4

    return div_4, div_8, div_16, div_32
def Backbone_Resnet34_in3():
    net=models.resnet34(pretrained=True)
    div=list(net.children())
    
    div_1=nn.Sequential(*div[0:5])#/2
    
    div_64_128=nn.Sequential(*div[5])#64->128
    
    div_128_256=nn.Sequential(*div[6])#128->256
    
    div_256_512=nn.Sequential(*div[7])
    return div_1,div_64_128,div_128_256,div_256_512
