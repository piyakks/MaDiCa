...
from .encoders.single_vmamba2 import vssm_small as backbone
from .decoders.MambaDecoder import MambaDecoder,MambaVisionDecoder
...
class Model(nn.Module):
    def __init__(self,img_size=352):
        ...
        self.decoder = MambaVisionDecoder(img_size=[img_size, img_size], 
                                    in_channels=self.channels, 
                                    num_classes=1, 
                                    depths=[2,2,2,2],#1,1,1,1
