import argparse
import os
from dataset.rgb_dataset_test import Dataset
import torch
...
parser.add_argument('--model_path', type=str, default='./checkpoints_camo_Dinat/rgb_datasets/best/new_upsample2_block4.pth')#
parser.add_argument('--test_dataset', type=str, default='COD10K')
parser.add_argument('--testsavefold', type=str, default='./COD10K_1')
...
for i, data_batch in enumerate(test_loader):
    ...
    with torch.no_grad():
        ...
        for i in range(config.test_batch_size):
            ...
            pre1 = torch.nn.Sigmoid()(saliency[0][i])
