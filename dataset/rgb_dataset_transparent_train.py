...
class Dataset(data.Dataset):
    def __init__(self, root_dir, mode='train', transform=None, return_size=True):
        ...
        img_dir = os.path.join('/mnt/d/Transparent',root_dir, mode, 'image')
        gt_dir  = os.path.join('/mnt/d/Transparent',root_dir, mode, 'pseudo-mask')
        scribble_dir=os.path.join('/mnt/d/Transparent',root_dir, mode, 'scribble')
