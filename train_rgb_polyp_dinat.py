import argparse
from dataset.rgb_dataset_polyp_train import Dataset
from dataset.rgb_dataset_polyp_test import Dataset as TestDataset
...
parser.add_argument('--save_fold', type=str, default='./checkpoints_polyp')  # 训练过程中输出的保存路径
...
if __name__ == '__main__':
    ...
    dataset_train = Dataset(root_dir='Kvasir',transform=composed_transforms_ts, mode='train')
